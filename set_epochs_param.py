...
##ID is set to 1 for acceptable trials, to 2 for rejected trials
...
##create matrices
##initial has ids of the 110 trials in the order they appear in the experiment (subject x trial)
